...
export class initial1591825327636 implements MigrationInterface {
    name = 'initial1591825327636'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `orders` (`id` int NOT NULL AUTO_INCREMENT, `status` enum ('scheduled', 'active', 'delivered', 'cancelled') NOT NULL DEFAULT 'scheduled', `description` varchar(255) NULL, `scheduledDate` timestamp NOT NULL, `finishedAt` timestamp NULL, `isPaid` tinyint(1) NOT NULL DEFAULT 0, `totalPrice` decimal(9,2) NOT NULL, `deliveryPrice` decimal(9,2) NOT NULL DEFAULT '0', `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `storeLocationId` int NULL, `customerId` int NULL, `courierId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
