...
export class initial1591906158112 implements MigrationInterface {
    name = 'initial1591906158112'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `couriers` (`id` int NOT NULL AUTO_INCREMENT, `status` enum ('pending', 'deleted', 'active', 'blocked', 'rejected') NOT NULL DEFAULT 'pending', `phoneNumber` varchar(20) NOT NULL, `firstName` varchar(50) NOT NULL, `lastName` varchar(50) NOT NULL, `email` varchar(50) NOT NULL, `passwordHash` varchar(50) NOT NULL, `passwordSalt` varchar(50) NOT NULL, `imageURL` varchar(255) NULL, `description` varchar(255) NULL, `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `languageId` int NULL, UNIQUE INDEX `IDX_dbb79407286509e8c44ea60d9d` (`email`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `managers` (`id` int NOT NULL AUTO_INCREMENT, `status` enum ('active', 'deleted') NOT NULL DEFAULT 'active', `firstName` varchar(50) NOT NULL, `lastName` varchar(50) NOT NULL, `email` varchar(50) NOT NULL, `passwordHash` varchar(50) NOT NULL, `passwordSalt` varchar(50) NOT NULL, `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, UNIQUE INDEX `IDX_8d5fd9a2217bf7b16bef11fdf8` (`email`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `storeLocations` (`id` int NOT NULL AUTO_INCREMENT, `latitude` decimal(10,8) NOT NULL, `longitude` decimal(11,8) NOT NULL, `address` varchar(100) NOT NULL, `postalCode` varchar(10) NOT NULL, `storeId` int NULL, UNIQUE INDEX `REL_cb58fa0289f3fa7dfd52a0cc18` (`storeId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `stores` (`id` int NOT NULL AUTO_INCREMENT, `title` varchar(50) NOT NULL, `slug` varchar(50) NOT NULL, `description` varchar(4096) NULL, `status` enum ('pending', 'active', 'blocked', 'deleted', 'rejected') NOT NULL DEFAULT 'pending', `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `ownerId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `productTranslations` (`id` int NOT NULL AUTO_INCREMENT, `title` varchar(50) NOT NULL, `description` varchar(255) NULL, `productId` int NULL, `languageId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `products` (`id` int NOT NULL AUTO_INCREMENT, `externalID` varchar(50) NOT NULL, `imageURL` varchar(255) NULL, `price` decimal(9,2) NOT NULL, `status` enum ('active', 'deleted') NOT NULL DEFAULT 'active', `storeId` int NULL, UNIQUE INDEX `IDX_c0e1fd57a2c86c1d3dadcf602f` (`externalID`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `orders` (`id` int NOT NULL AUTO_INCREMENT, `status` enum ('scheduled', 'active', 'delivered', 'cancelled') NOT NULL DEFAULT 'scheduled', `description` varchar(255) NULL, `scheduledDate` timestamp NOT NULL, `finishedAt` timestamp NULL, `isPaid` tinyint(1) NOT NULL DEFAULT 0, `totalPrice` decimal(9,2) NOT NULL, `deliveryPrice` decimal(9,2) NOT NULL DEFAULT '0', `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `courierId` int NULL, `storeLocationId` int NULL, `customerId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `orders` DROP FOREIGN KEY `FK_757d699ef7b865116ff8e54515a`");
        ...
        await queryRunner.query("ALTER TABLE `stores` DROP FOREIGN KEY `FK_a447ba082271c05997a61df26df`");
        await queryRunner.query("ALTER TABLE `storeLocations` DROP FOREIGN KEY `FK_cb58fa0289f3fa7dfd52a0cc187`");
        ...
        await queryRunner.query("DROP INDEX `IDX_c0e1fd57a2c86c1d3dadcf602f` ON `products`");
        await queryRunner.query("DROP TABLE `products`");
        await queryRunner.query("DROP TABLE `productTranslations`");
        await queryRunner.query("DROP TABLE `stores`");
        await queryRunner.query("DROP INDEX `REL_cb58fa0289f3fa7dfd52a0cc18` ON `storeLocations`");
